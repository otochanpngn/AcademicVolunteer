...
public class Poi : Token {
	...
	void Update () {
		...
		x = x + 0.1f;
		*/
		Debug.Log ("UpdateStatus:"+senstickStatus);
	}
	...
	private void OnTriggerStay2D(Collider2D other){
		Debug.Log ("stats:" + senstickStatus);
		if (senstickStatus) {
